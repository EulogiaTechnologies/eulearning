                                            ...
                                            <div class="pl-20 text-right ml-3 d-flex align-items-center">
                                                ...
                                                @if (0==array_search($current_page,$lesson_ids))
                                                    <a href="#" disabled="disabled"
                                                       class="theme_btn theme_button_disabled small_btn2 p-2 m-1 disabled">{{__('frontend.Previous')}}</a>
                                                @else
                                                    <a href="#"
                                                       onclick="goFullScreen({{$course->id}},{{$lesson_ids[$current_index-1]}})"
                                                       class="theme_btn small_btn2 p-2 m-1">{{__('frontend.Previous')}}</a>
                                                @endif
                                                ...
                                                @if (array_search($current_page,$lesson_ids) < array_search(end($lesson_ids),$lesson_ids) )
                                                    ...
                                                    <a href="#" id="next_lesson_btn"
                                                       onclick="goFullScreen({{$course->id}},{{$lesson_ids[$current_index+1]}})"
                                                       class="theme_btn small_btn2 p-2 m-1">{{__('frontend.Next')}}</a>
                                                @else
                                                    <a href="#" disabled
                                                       class="theme_btn theme_button_disabled small_btn2 p-2 m-1 disabled"
                                                       style="opacity: 1">{{__('frontend.Next')}}</a>
                                                @endif
                                            </div>
                                        @endif
    ...
    <div class="course_fullview_wrapper">
        ...
        @else
            ...
            @if (isModuleActive('BunnyStorage') && $lesson->host=='BunnyStorage')
                @php
                    $time = \Illuminate\Support\Carbon::now()->addDay(1)->unix();
                    ...
                    }else if($lesson->bunnyLesson && $lesson->bunnyLesson->service_type == 'storage'){
