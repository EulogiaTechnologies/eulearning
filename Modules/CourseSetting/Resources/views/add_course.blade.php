                    ...
                    <div class="row mt-20">
                        <div class="col-xl-6">
                            <div class="primary_input mb-35">
                                ...
                                <div class="primary_file_uploader">
                                    <input class="primary-input filePlaceholder courseLabel" type="text"
                                           id=""
                                           {{$errors->has('image') ? 'autofocus' : ''}}
                                    ...
                                    <div class="multi_btn">
                                        <button class="" type="button">
                                            ...
                                            <input type="file" class="d-none fileUpload courseLabel" name="image"
                                                   id="document_file_thumb_2">
                                        </button>
                                        <button type="button" data-table="courses"
                                                data-name="thumbnail"
                                                data-id="0"
                                                data-label=".courseLabel"
